...
use YunitsForWP\Vendor_Prefixed\DI\Definition\Resolver\ResolverDispatcher;
use YunitsForWP\Vendor_Prefixed\DI\Definition\Source\DefinitionArray;
use YunitsForWP\Vendor_Prefixed\DI\Definition\Source\MutableDefinitionSource;
use YunitsForWP\Vendor_Prefixed\DI\Definition\Source\ReflectionBasedAutowiring;
use YunitsForWP\Vendor_Prefixed\DI\Definition\Source\SourceChain;
use YunitsForWP\Vendor_Prefixed\DI\Definition\ValueDefinition;
use YunitsForWP\Vendor_Prefixed\DI\Invoker\DefinitionParameterResolver;
use YunitsForWP\Vendor_Prefixed\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use YunitsForWP\Vendor_Prefixed\Invoker\Invoker;
use YunitsForWP\Vendor_Prefixed\Invoker\InvokerInterface;
use YunitsForWP\Vendor_Prefixed\Invoker\ParameterResolver\AssociativeArrayResolver;
use YunitsForWP\Vendor_Prefixed\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use YunitsForWP\Vendor_Prefixed\Invoker\ParameterResolver\DefaultValueResolver;
use YunitsForWP\Vendor_Prefixed\Invoker\ParameterResolver\NumericArrayResolver;
use YunitsForWP\Vendor_Prefixed\Invoker\ParameterResolver\ResolverChain;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. \YunitsForWP\Vendor_Prefixed\DI\get().
     *
