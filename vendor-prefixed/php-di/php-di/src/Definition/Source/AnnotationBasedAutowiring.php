...
use YunitsForWP\Vendor_Prefixed\DI\Annotation\Inject;
use YunitsForWP\Vendor_Prefixed\DI\Annotation\Injectable;
use YunitsForWP\Vendor_Prefixed\DI\Definition\Exception\InvalidAnnotation;
use YunitsForWP\Vendor_Prefixed\DI\Definition\ObjectDefinition;
use YunitsForWP\Vendor_Prefixed\DI\Definition\ObjectDefinition\MethodInjection;
use YunitsForWP\Vendor_Prefixed\DI\Definition\ObjectDefinition\PropertyInjection;
use YunitsForWP\Vendor_Prefixed\DI\Definition\Reference;
use YunitsForWP\Vendor_Prefixed\Doctrine\Common\Annotations\AnnotationRegistry;
use YunitsForWP\Vendor_Prefixed\Doctrine\Common\Annotations\Reader;
use YunitsForWP\Vendor_Prefixed\Doctrine\Common\Annotations\SimpleAnnotationReader;
use InvalidArgumentException;
use YunitsForWP\Vendor_Prefixed\PhpDocReader\PhpDocReader;
use ReflectionClass;
...
class AnnotationBasedAutowiring implements DefinitionSource, Autowiring
{
    ...
    private function readProperty(ReflectionProperty $property, ObjectDefinition $definition, $classname = null)
    {
        ...
        $annotation = $this->getAnnotationReader()->getPropertyAnnotation($property, 'YunitsForWP\Vendor_Prefixed\DI\Annotation\Inject');
    ...
    private function getMethodInjection(ReflectionMethod $method)
    {
        // Look for @Inject annotation
        try {
            $annotation = $this->getAnnotationReader()->getMethodAnnotation($method, 'YunitsForWP\Vendor_Prefixed\DI\Annotation\Inject');
    ...
    public function getAnnotationReader()
    {
        if ($this->annotationReader === null) {
            ...
            $this->annotationReader->addNamespace('YunitsForWP\Vendor_Prefixed\DI\Annotation');
        }
    ...
    private function readInjectableAnnotation(ReflectionClass $class, ObjectDefinition $definition)
    {
        try {
            ...
            $annotation = $this->getAnnotationReader()
                ->getClassAnnotation($class, 'YunitsForWP\Vendor_Prefixed\DI\Annotation\Injectable');
